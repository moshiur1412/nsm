            ...
            <div class="body">
                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                        ...
                        <tbody>
                            @foreach($award_actions as $award_action)
                            <tr>
                                <td>{{$award_action->created_at}}</td>
                                <td>{!! '<a href="'.route('awardApplications.edit', $award_action->award->id).'">'.$award_action->award->name.'</a>' !!}</td>
                                <td>{{$award_action->action}}</td>
                            </tr>
                            @endforeach
