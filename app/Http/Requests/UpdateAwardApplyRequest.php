...
class UpdateAwardApplyRequest extends FormRequest
{
    /**
    ...
    public function rules()
    {
        ...
        return [
            ...
            'occupation'=>'required',
            'job_other'=>'required_if:occupation,"その他"',
            'postalcode_1'=>'required|string',
            'postalcode_2'=>'required|string',
    ...
    {
        \Log::error('Error: UpdateAwardApplyRequest validation failed!');
    }
}
